...
abstract class AbstractExtension implements FormExtensionInterface
{
    ...
    private function initTypes()
    {
        ...
        foreach ($this->loadTypes() as $type) {
            if (!$type instanceof FormTypeInterface) {
                throw new UnexpectedTypeException($type, 'WooRefill\Symfony\Component\Form\FormTypeInterface');
            }
    ...
    private function initTypeExtensions()
    {
        ...
        foreach ($this->loadTypeExtensions() as $extension) {
            if (!$extension instanceof FormTypeExtensionInterface) {
                throw new UnexpectedTypeException($extension, 'WooRefill\Symfony\Component\Form\FormTypeExtensionInterface');
            }
    ...
    private function initTypeGuesser()
    {
        ...
        if (null !== $this->typeGuesser && !$this->typeGuesser instanceof FormTypeGuesserInterface) {
            throw new UnexpectedTypeException($this->typeGuesser, 'WooRefill\Symfony\Component\Form\FormTypeGuesserInterface');
        }
    }
}
