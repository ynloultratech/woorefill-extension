...
namespace WooRefill\Symfony\Bridge\Twig\Translation;
...
class TwigExtractor extends AbstractFileExtractor implements ExtractorInterface
{
    ...
    {
        $visitor = $this->twig->getExtension('WooRefill\Symfony\Bridge\Twig\Extension\TranslationExtension')->getTranslationNodeVisitor();
        $visitor->enable();
