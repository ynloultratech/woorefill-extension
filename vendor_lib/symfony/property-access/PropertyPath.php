...
use WooRefill\Symfony\Component\PropertyAccess\Exception\InvalidPropertyPathException;
use WooRefill\Symfony\Component\PropertyAccess\Exception\OutOfBoundsException;
    ...
    public function __construct($propertyPath)
    {
        ...
        if (!is_string($propertyPath)) {
            throw new InvalidArgumentException(sprintf(
                ...
                '"WooRefill\Symfony\Component\PropertyAccess\PropertyPath". '.
                'Got: "%s"',
