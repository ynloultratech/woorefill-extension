...
namespace WooRefill\Symfony\Component\Intl\Data\Bundle\Writer;

use WooRefill\Symfony\Component\Intl\Exception\UnexpectedTypeException;

/**
 * Writes .txt resource bundles.
 *
 * The resulting files can be converted to binary .res files using a
 * {@link \WooRefill\Symfony\Component\Intl\ResourceBundle\Compiler\BundleCompilerInterface}
 * implementation.
 *
