...
use WooRefill\Symfony\Component\Form\ChoiceList\Factory\CachingFactoryDecorator;
use WooRefill\Symfony\Component\Form\ChoiceList\Factory\PropertyAccessDecorator;
use WooRefill\Symfony\Component\Form\ChoiceList\View\ChoiceGroupView;
use WooRefill\Symfony\Component\Form\ChoiceList\ChoiceListInterface;
use WooRefill\Symfony\Component\Form\ChoiceList\Factory\DefaultChoiceListFactory;
use WooRefill\Symfony\Component\Form\ChoiceList\Factory\ChoiceListFactoryInterface;
use WooRefill\Symfony\Component\Form\ChoiceList\View\ChoiceListView;
use WooRefill\Symfony\Component\Form\ChoiceList\View\ChoiceView;
use WooRefill\Symfony\Component\Form\Exception\TransformationFailedException;
use WooRefill\Symfony\Component\Form\Extension\Core\DataMapper\RadioListMapper;
use WooRefill\Symfony\Component\Form\Extension\Core\DataMapper\CheckboxListMapper;
...
use WooRefill\Symfony\Component\Form\Extension\Core\EventListener\MergeCollectionListener;
use WooRefill\Symfony\Component\Form\Extension\Core\DataTransformer\ChoiceToValueTransformer;
use WooRefill\Symfony\Component\Form\Extension\Core\DataTransformer\ChoicesToValuesTransformer;
use WooRefill\Symfony\Component\Form\Util\FormUtil;
...
class ChoiceType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setAllowedTypes('choice_loader', array('null', 'WooRefill\Symfony\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface'));
        $resolver->setAllowedTypes('choice_label', array('null', 'bool', 'callable', 'string', 'WooRefill\Symfony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('choice_name', array('null', 'callable', 'string', 'WooRefill\Symfony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('choice_value', array('null', 'callable', 'string', 'WooRefill\Symfony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('choice_attr', array('null', 'array', 'callable', 'string', 'WooRefill\Symfony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('preferred_choices', array('array', '\Traversable', 'callable', 'string', 'WooRefill\Symfony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('group_by', array('null', 'callable', 'string', 'WooRefill\Symfony\Component\PropertyAccess\PropertyPath'));
    }
