...
namespace WooRefill\Symfony\Component\Form;

use WooRefill\Symfony\Component\Form\Exception\RuntimeException;
use WooRefill\Symfony\Component\Form\Exception\UnexpectedTypeException;
use WooRefill\Symfony\Component\Form\Exception\AlreadySubmittedException;
use WooRefill\Symfony\Component\Form\Exception\TransformationFailedException;
use WooRefill\Symfony\Component\Form\Exception\LogicException;
use WooRefill\Symfony\Component\Form\Exception\OutOfBoundsException;
use WooRefill\Symfony\Component\Form\Util\FormUtil;
use WooRefill\Symfony\Component\Form\Util\InheritDataAwareIterator;
use WooRefill\Symfony\Component\Form\Util\OrderedHashMap;
    ...
    public function add($child, $type = null, array $options = array())
    {
        ...
        if (!$child instanceof FormInterface) {
            if (!is_string($child) && !is_int($child)) {
                throw new UnexpectedTypeException($child, 'string, integer or WooRefill\Symfony\Component\Form\FormInterface');
            }

            if (null !== $type && !is_string($type) && !$type instanceof FormTypeInterface) {
                throw new UnexpectedTypeException($type, 'string or WooRefill\Symfony\Component\Form\FormTypeInterface');
            }
            ...
            if (null === $type && null === $this->config->getDataClass()) {
                $type = 'WooRefill\Symfony\Component\Form\Extension\Core\Type\TextType';
            }
