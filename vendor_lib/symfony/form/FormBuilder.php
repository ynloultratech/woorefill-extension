...
use WooRefill\Symfony\Component\Form\Exception\BadMethodCallException;
use WooRefill\Symfony\Component\Form\Exception\InvalidArgumentException;
use WooRefill\Symfony\Component\Form\Exception\UnexpectedTypeException;
use WooRefill\Symfony\Component\EventDispatcher\EventDispatcherInterface;
...
class FormBuilder extends FormConfigBuilder implements \IteratorAggregate, FormBuilderInterface
{
    ...
    public function add($child, $type = null, array $options = array())
    {
        ...
        if (!is_string($child) && !is_int($child)) {
            throw new UnexpectedTypeException($child, 'string, integer or WooRefill\Symfony\Component\Form\FormBuilderInterface');
        }
