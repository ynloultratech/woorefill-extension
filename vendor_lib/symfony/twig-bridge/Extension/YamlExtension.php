...
use WooRefill\Symfony\Component\Yaml\Dumper as YamlDumper;
use WooRefill\Symfony\Component\Yaml\Yaml;
...
class YamlExtension extends \Twig_Extension
{
    ...
    public function encode($input, $inline = 0, $dumpObjects = 0)
    {
        ...
        if (defined('WooRefill\Symfony\Component\Yaml\Yaml::DUMP_OBJECT')) {
