...
use WooRefill\Symfony\Component\Form\Exception\ExceptionInterface;
    ...
    public function __construct(array $extensions, ResolvedFormTypeFactoryInterface $resolvedTypeFactory)
    {
        foreach ($extensions as $extension) {
            if (!$extension instanceof FormExtensionInterface) {
                throw new UnexpectedTypeException($extension, 'WooRefill\Symfony\Component\Form\FormExtensionInterface');
            }
        }
    ...
    public function getType($name)
    {
        if (!isset($this->types[$name])) {
            ...
            if (!$type) {
                ...
                if (class_exists($name) && in_array('WooRefill\Symfony\Component\Form\FormTypeInterface', class_implements($name))) {
                    $type = new $name();
                } else {
