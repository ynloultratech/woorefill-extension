...
use WooRefill\Symfony\Component\PropertyAccess\PropertyPathBuilder;
use WooRefill\Symfony\Component\PropertyAccess\PropertyPathIteratorInterface;
    ...
    private function reconstructPath(ViolationPath $violationPath, FormInterface $origin)
    {
        ...
        for ($it->rewind(); $it->valid() && $it->mapsForm(); $it->next()) {
            ...
            if ($scope->getConfig()->getInheritData()) {
                ...
                /* @var \WooRefill\Symfony\Component\PropertyAccess\PropertyPathInterface $propertyPath */
